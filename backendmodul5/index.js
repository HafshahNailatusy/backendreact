...
app.post("/pegawai", (req,res) => {
    ...
    let sql = "select * from pegawais where nip like '%"+find+"%' or nama like '%"+find+"%' or alamat like '%"+find+"%'"
    db.query(sql, (err, result) => {
        if (err) {
            throw err
        } else {
...
app.post("/pegawai/save", (req,res) => {
    ...
    let sql = "insert into pegawais set ?"
...
app.post("/pegawai/update", (req,res) => {
    ...
    let sql = "update pegawais set ? where nip = ?"
    db.query(sql, data, (err,result) => {
        if (err) {
            message = err.message
        } else {
...
app.delete("/pegawai/:nip", (req,res) => {
    ...
    let message = ""
    let sql = "delete from pegawais where ?"
    db.query(sql, data, (err,result) => {
        if (err) {
            message = err.message
        } else {
